        ...
        public List<ChuongTrinhDaoTaoDTO> LayDanhSachChuongTrinhDaoTao()
        {
            try
            {
                var lstctrdaotao = model.MonHocKhoaDaoTaos.Select(s => new ChuongTrinhDaoTaoDTO
                {
                    ...
                    IDHocPhanTienQuyet = s.MonHoc.IDHocPhanTienQuyet,
                    TenHocPhanTienQuyet = s.MonHoc.HocPhanTienQuyet.TenHocPhan,
                    IDHocPhanHocTruoc = s.MonHoc.IDHocPhanHocTruoc,
                    TenHocPhanHocTruoc = s.MonHoc.HocPhanHocTruoc.TenHocPhan,
